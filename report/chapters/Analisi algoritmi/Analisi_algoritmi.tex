...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{ |P{2cm}|P{1cm}|P{1cm}|P{1cm}|P{1.8cm}|P{1cm}|P{1cm}|P{1cm}|P{1.8cm}| } 
            \multicolumn{8}{c}{\textbf{Random Forest}} \\
            \hline
            & \multicolumn{3}{c|}{\textbf{Dataset HAR}} & &\multicolumn{3}{c|}{\textbf{Dataset Real}}  & \\
            \hline
            \rowcolor{lightgray}
            ...
            \hline
            \rowcolor{lightgray}
            \textbf{Accuracy} & \multicolumn{3}{c|}{0.9247830279652844} & 3111 &\multicolumn{3}{c|}{0.8434782608695652} & 115 \\
            \hline
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{cf_HARSensorData.png}
    \includegraphics[width=0.49\textwidth]{cf_SensorData.png}
