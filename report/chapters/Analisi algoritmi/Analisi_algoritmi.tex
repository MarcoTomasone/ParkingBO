...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{ |P{2cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1.8cm}| } 
            ...
            \hline
            \textbf{Accuracy} & \multicolumn{3}{c|}{0.8927855711422845} &\multicolumn{3}{c|}{0.9524048096192385} &\multicolumn{3}{c|}{}& 3992 \\
            \hline
            \rowcolor{lightgray}
...
\begin{table}[H]
    \begin{center}
        \begin{tabular}{ |P{2cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1cm}|P{1.8cm}| } 
            ...
            \hline
            \textbf{Accuracy} & \multicolumn{3}{c|}{0.8927855711422845} &\multicolumn{3}{c|}{0.0.8982965931863728} &\multicolumn{3}{c|}{}& 3992 \\
            \hline
            \rowcolor{lightgray}
